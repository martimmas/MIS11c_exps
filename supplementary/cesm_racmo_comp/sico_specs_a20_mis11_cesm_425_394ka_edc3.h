...
#define RUNNAME      'a20_mis11_cesm_425_395ka_edc3'
!                      Name of simulation
...
#define OUTPATH      '/home/mbraga/sicopolis/data/output/sico_out/a20_mis11_cesm_425_395ka_edc3'
...
#define ANFDATNAME 'a20_mis11_cesm_therma_ccsm3init0003.nc'
...
#define ZS_TEMP_FILE  'ant_jb_20_el_cesm_pi.dat'
!                             Name of the file containing the reference
...
#define TEMP_MM_PRESENT_FILE 'ant_jb_20_tm_cesm_pi.dat'
...
#define TEMP_MM_ANOM_FILE 'ant_jb_20_tm_cesm_lgm_anom.dat'
!                       Name of the file containing the LGM
!                       mean-monthly surface-temperature-anomaly data
!                       (difference LGM - present; for TSURFACE==5)

#define TEMP_MA_ANOM_FILE 'ant_jb_20_ta_cesm_lgm_anom.dat'
!                       Name of the file containing the LGM
!                       mean-annual surface-temperature-anomaly data
!                       (difference LGM - present; for TSURFACE==5)

#define TEMP_MJ_ANOM_FILE 'ant_jb_20_mj_cesm_lgm_anom.dat'
!                       Name of the file containing the LGM
...
#define PRECIP_PRESENT_FILE 'ant_jb_20_pa_cesm_pi.dat'
...
#define PRECIP_ANOM_FILE 'ant_jb_20_pm_cesm_lgm_anom.dat'
...
#define C_SLIDE_FILE      'ant_xx_20_sld_cesm.dat'
!                       Name of the file containing the spatially varying
...
#define OCN_FILE       'ant_jb_20_to_cesm_pi.dat'
!                       Name of the file containing the spatially varying
!                       3-D ocean temperature data (only for QBM_MODE==3)

#define OCN_LGM_ANOM_FILE 'ant_jb_20_to_cesm_lgm_anom.dat'
!                          Name of the file containing the spatially varying
...
#define TIME_OUT0_01 -4.16d+05
#define TIME_OUT0_02 -4.10d+05
#define TIME_OUT0_03 -4.05d+05
#define TIME_OUT0_04 -4.00d+05
#define TIME_OUT0_05 -3.97d+05
#define TIME_OUT0_06 -3.94d+05
