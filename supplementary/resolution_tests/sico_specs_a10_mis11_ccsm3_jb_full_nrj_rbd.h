...
#define RUNNAME      'a10_mis11_ccsm3_jb_full_nrj_rbd'
!                      Name of simulation

#define SICO_VERSION '3.2-dev'
!                      Version number of SICOPOLIS

#define INPATH       '/mnt/wrk1/bernales/software/sicopolis/sico_braga/sico_in'
!                      Directory for SICOPOLIS input
!                      (no '/' at the end!)

#define OUTPATH      '/mnt/wrk1/bernales/data/output/sico_out/sico_braga/a10_mis11_ccsm3_jb_full_nrj_rbd'
...
#define TIME_INIT0   -4.24900d+05
!                       Initial time of simulation (in a)

#define TIME_END0    -3.94d+05
!                       Final time of simulation (in a)

#define DTIME0       5.00d-01
!                       Time step (in a) for computation of velocity
!                       and topography

#define DTIME_TEMP0  5.00d-01
...
#define ANFDATNAME 'a10_mis11_ccsm3_jb_zl_nrj0001.nc'
!                             Initial-value file (only for ANF_DAT==3)

#define ANFDATPATH '/home/bernales/software/sicopolis/sico_braga/sico_init'
!                             Directory for initial-value file
!                             (no '/' at the end!)

![S]----- Reference topography --------

#define ZS_REF_FILE   'ant_rg_10_zs.dat'
!                             Name of the file containing the reference
!                             ice-surface topography

#define ZB_REF_FILE   'ant_rg_10_zb.dat'
!                             Name of the file containing the reference
!                             ice-base topography (only for ANF_DAT==1)

#define ZL_REF_FILE   'ant_rg_10_zl.dat'
!                             Name of the file containing the reference
!                             lithosphere-surface topography

#define ZS_TEMP_FILE  'ant_jb_10_el_ccsm3_mis11_000ka.dat'
!                             Name of the file containing the reference
...
#define ZL_TARGET_MODE 0

#define ZL_TARGET_FILE 'none'
...
#define TIME_TARGET_TOPO_INIT0  -425000.0d0
!                             Initial time for target-topography adjustment
!                             (in a; only for ZS_EVOL==2)

#define TIME_TARGET_TOPO_FINAL0 -424900.0d0
...
#define TEMP_MM_PRESENT_FILE 'ant_jb_10_tm_ccsm3_mis11_000ka.dat'
...
#define TEMP_MM_ANOM_FILE 'ant_jb_10_tm_ccsm3_mis11_anomlgm_pri.dat'
!                       Name of the file containing the LGM
!                       mean-monthly surface-temperature-anomaly data
!                       (difference LGM - present; for TSURFACE==5)

#define TEMP_MA_ANOM_FILE 'ant_jb_10_ta_ccsm3_mis11_anomlgm_pri.dat'
!                       Name of the file containing the LGM
!                       mean-annual surface-temperature-anomaly data
!                       (difference LGM - present; for TSURFACE==5)

#define TEMP_MJ_ANOM_FILE 'ant_jb_10_mj_ccsm3_mis11_anomlgm_pri.dat'
!                       Name of the file containing the LGM
...
#define PRECIP_PRESENT_FILE 'ant_jb_10_pa_ccsm3_mis11_000ka.dat'
...
#define PRECIP_ANOM_FILE 'ant_jb_10_pm_ccsm3_mis11_anomlgm_pri.dat'
...
#define C_SLIDE_FILE      'ant_xx_10_sld_ccsm3_mis11_pi_nrj.dat'
!                       Name of the file containing the spatially varying
...
#define Q_GEO_FILE 'ant_sr_10_qg_fm.dat'
!                       Name of the file containing the spatially varying
...
!			2 : Separate Glacial Index for the ocean,
!			    provided by GLAC_IND_OCN_FILE

#define GLAC_IND_OCN_FILE 'edc3_gi_800kyr_300lag.dat'
!                       Name of the file containing the ocean 
!                       glacial-index forcing
!                       (only for TSURFACE==5 and QBM_GLAC==2)
...
#define OCN_FILE       'ant_jb_10_to_ccsm3_mis11_000ka.dat'
!                       Name of the file containing the spatially varying
!                       3-D ocean temperature data (only for QBM_MODE==3)

#define OCN_LGM_ANOM_FILE 'ant_jb_10_to_ccsm3_mis11_anomlgm_pri.dat'
!                          Name of the file containing the spatially varying
...
#define TIME_OUT0_01 -4.20d+05
#define TIME_OUT0_02 -4.16d+05
#define TIME_OUT0_03 -4.15d+05
#define TIME_OUT0_04 -4.10d+05
#define TIME_OUT0_05 -3.05d+05
#define TIME_OUT0_06 -4.00d+05
#define TIME_OUT0_07 -3.95d+05
#define TIME_OUT0_08 -3.94d+05
