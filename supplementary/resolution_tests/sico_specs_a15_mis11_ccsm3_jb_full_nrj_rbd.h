...
#define RUNNAME      'a15_mis11_ccsm3_jb_full_nrj_rbd'
!                      Name of simulation
...
#define OUTPATH      '/mnt/wrk1/bernales/data/output/sico_out/sico_braga/a15_mis11_ccsm3_jb_full_nrj_rbd'
...
#define ANFDATNAME 'a10_mis11_ccsm3_jb_zl_nrj0001_DBL15.nc'
...
#define ZS_REF_FILE   'ant_rg_15_zs.dat'
!                             Name of the file containing the reference
!                             ice-surface topography

#define ZB_REF_FILE   'ant_rg_15_zb.dat'
!                             Name of the file containing the reference
!                             ice-base topography (only for ANF_DAT==1)

#define ZL_REF_FILE   'ant_rg_15_zl.dat'
!                             Name of the file containing the reference
!                             lithosphere-surface topography

#define ZS_TEMP_FILE  'ant_jb_15_el_ccsm3_mis11_000ka.dat'
!                             Name of the file containing the reference
...
#define TEMP_MM_PRESENT_FILE 'ant_jb_15_tm_ccsm3_mis11_000ka.dat'
...
#define TEMP_MM_ANOM_FILE 'ant_jb_15_tm_ccsm3_mis11_anomlgm_pri.dat'
!                       Name of the file containing the LGM
!                       mean-monthly surface-temperature-anomaly data
!                       (difference LGM - present; for TSURFACE==5)

#define TEMP_MA_ANOM_FILE 'ant_jb_15_ta_ccsm3_mis11_anomlgm_pri.dat'
!                       Name of the file containing the LGM
...
#define PRECIP_PRESENT_FILE 'ant_jb_15_pa_ccsm3_mis11_000ka.dat'
...
#define PRECIP_ANOM_FILE 'ant_jb_15_pm_ccsm3_mis11_anomlgm_pri.dat'
...
#define C_SLIDE_FILE      'ant_xx_15_sld_ccsm3_mis11_pi_nrj.dat'
!                       Name of the file containing the spatially varying
...
#define Q_GEO_FILE 'ant_sr_15_qg_fm.dat'
!                       Name of the file containing the spatially varying
...
#define OCN_FILE       'ant_jb_15_to_ccsm3_mis11_000ka.dat'
!                       Name of the file containing the spatially varying
!                       3-D ocean temperature data (only for QBM_MODE==3)

#define OCN_LGM_ANOM_FILE 'ant_jb_15_to_ccsm3_mis11_anomlgm_pri.dat'
!                          Name of the file containing the spatially varying
